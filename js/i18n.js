...
(function () {
  ...
  const dict = {
    ...
    /* ── GALLERY PAGE ───────────────────────────────────────── */
    'nav.gallery':             { en: 'Gallery / Events', hi: 'गैलरी / इवेंट्स' },
    'gallery.title':           { en: 'Gallery & Events | Pawan Enterprise', hi: 'गैलरी और इवेंट्स | पवन एंटरप्राइज' },
    'gallery.nav.loc':         { en: 'Gallery · Pawan Enterprise', hi: 'गैलरी · पवन एंटरप्राइज' },
    'gallery.nav.bricks':      { en: 'Gramin Brick Field', hi: 'ग्रामीण ईंट भट्ठा' },
    'gallery.nav.fuel':        { en: 'Pawan Filling Station', hi: 'पवन फिलिंग स्टेशन' },
    'gallery.nav.logo.main':   { en: 'Gallery &', hi: 'गैलरी और' },
    'gallery.nav.logo.sub':    { en: 'Events', hi: 'इवेंट्स' },
    'gallery.hero.title':      { en: 'Our Operations <span class="accent">In Focus</span>', hi: 'हमारे कार्य <span class="accent">तस्वीरों में</span>' },
    'gallery.hero.desc':       { en: 'A visual journey through the industrial scale of Gramin Brick Field and the round-the-clock service of Pawan Filling Station.', hi: 'ग्रामीण ईंट भट्ठे के औद्योगिक स्तर और पवन फिलिंग स्टेशन की 24 घंटे सेवा के माध्यम से एक दृश्य यात्रा।' },
    'gallery.zone.bricks.title': { en: 'Gramin Brick Field', hi: 'ग्रामीण ईंट भट्ठा' },
    'gallery.brick.1.title':   { en: 'Massive Kiln Firing', hi: 'विशाल भट्ठा फायरिंग' },
    'gallery.brick.1.sub':     { en: 'Temperature exceeding 1000°C', hi: '1000°C से अधिक तापमान' },
    'gallery.brick.2.title':   { en: 'Precision Stacking', hi: 'सटीक स्टैकिंग' },
    'gallery.brick.2.sub':     { en: 'Ready for curing', hi: 'पकने के लिए तैयार' },
    'gallery.brick.3.title':   { en: 'Heavy Load Operations', hi: 'भारी भार संचालन' },
    'gallery.brick.3.sub':     { en: 'Fleet maneuvering', hi: 'वाहनों का संचालन' },
    'gallery.brick.4.title':   { en: 'Quality Inspection', hi: 'गुणवत्ता निरीक्षण' },
    'gallery.brick.4.sub':     { en: 'Sorting Awwal grade', hi: 'अव्वल ग्रेड छंटाई' },
    'gallery.zone.fuel.title': { en: 'Pawan Filling Station', hi: 'पवन फिलिंग स्टेशन' },
    'gallery.fuel.1.title':    { en: 'Night Operations', hi: 'रात्रिकालीन सेवाएं' },
    'gallery.fuel.1.sub':      { en: 'Constant service under the lights', hi: 'रोशनी में निरंतर सेवा' },
    'gallery.fuel.2.title':    { en: 'Official HP Partner', hi: 'आधिकारिक एचपी भागीदार' },
    'gallery.fuel.2.sub':      { en: 'Guaranteed quality & quantity', hi: 'गुणवत्ता और मात्रा की गारंटी' },
    'gallery.fuel.3.title':    { en: 'Commercial Fleet Servicing', hi: 'वाणिज्यिक फ्लीट सेवा' },
    ...
    'gallery.bricks.tag':      { en: 'Gramin Brick Field · Kiln & Yard Operations', hi: 'ग्रामीण ईंट भट्ठा · भट्ठा और यार्ड कार्य' },
    'gallery.fuel.tag':        { en: 'Pawan Filling Station · Official HP Franchise', hi: 'पवन फिलिंग स्टेशन · आधिकारिक HP फ्रेंचाइजी' },
    'gallery.badge.kiln':      { en: 'Kiln Firing', hi: 'भट्ठा फायरिंग' },
    'gallery.badge.stacking':  { en: 'Stacking Yard', hi: 'स्टैकिंग यार्ड' },
    'gallery.badge.fleet':     { en: 'Machinery', hi: 'मशीनरी' },
    'gallery.badge.quality':   { en: 'Quality Control', hi: 'गुणवत्ता नियंत्रण' },
    'gallery.brick.5.title':   { en: 'Raw Moulding Yard', hi: 'कच्ची ढलाई यार्ड' },
    'gallery.brick.5.sub':     { en: 'Hand-moulded clay bricks', hi: 'हाथ से बनी मिट्टी की ईंटें' },
    'gallery.brick.6.title':   { en: 'Dispatch & Fleet Logistics', hi: 'प्रेषण और बेड़ा रसद' },
    'gallery.brick.6.sub':     { en: 'Direct site delivery', hi: 'सीधे साइट पर डिलीवरी' },
    'gallery.badge.moulding':  { en: 'Moulding', hi: 'ढलाई' },
    'gallery.badge.dispatch':  { en: 'Dispatch', hi: 'प्रेषण' },

    'gallery.badge.night':     { en: 'Day & Night', hi: 'दिन और रात' },
    'gallery.badge.hp':        { en: 'Official HP', hi: 'आधिकारिक HP' },
    'gallery.badge.fleet-serv':{ en: 'Fleet Lane', hi: 'फ्लीट लेन' },
    'gallery.badge.dispense':  { en: 'HP Verified', hi: 'HP सत्यापित' },
    'gallery.fuel.5.title':    { en: 'Clean Station Amenities', hi: 'स्वच्छ स्टेशन सुविधाएं' },
    'gallery.fuel.5.sub':      { en: 'Air, water & driver rest area', hi: 'हवा, पानी और ड्राइवर विश्राम क्षेत्र' },
    'gallery.fuel.6.title':    { en: 'Fuel Tanker Offloading', hi: 'ईंधन टैंकर ऑफलोडिंग' },
    'gallery.fuel.6.sub':      { en: 'Direct HP terminal supply', hi: 'सीधे एचपी टर्मिनल आपूर्ति' },
    'gallery.badge.amenities': { en: 'Amenities', hi: 'सुविधाएं' },
    'gallery.badge.supply':    { en: 'HP Supply', hi: 'HP आपूर्ति' },
