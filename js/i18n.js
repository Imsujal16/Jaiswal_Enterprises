...
(function () {
  ...
  const dict = {
    ...
    'form.select.fuel.account':{ en: 'Setting up a business account', hi: 'व्यावसायिक खाता खोलना' },
    'form.select.fuel.bulk':   { en: 'Bulk diesel for multiple vehicles', hi: 'कई वाहनों के लिए बल्क डीजल' },
    'form.select.fuel.gen':    { en: 'General fuel or service query', hi: 'सामान्य ईंधन या सेवा प्रश्न' },
