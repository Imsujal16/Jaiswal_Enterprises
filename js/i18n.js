...
(function () {
  ...
  const dict = {
    ...
    'test.2.quote':          { en: '"We run our entire fleet of school buses and vans through Pawan Station. When transporting children every single morning, fuel purity and vehicle reliability are non-negotiable. From day one, their pure HP fuel, prompt service, and transparent billing have made them our trusted refueling partner."', hi: '"हम अपनी स्कूल बसों और वैनों के पूरे बेड़े के लिए पवन स्टेशन पर निर्भर हैं। हर सुबह बच्चों को ले जाते समय ईंधन की शुद्धता और वाहन की विश्वसनीयता से समझौता नहीं किया जा सकता। पहले दिन से ही उनका शुद्ध HP ईंधन और पारदर्शी बिलिंग हमें पूर्ण भरोसा देता है।"' },
