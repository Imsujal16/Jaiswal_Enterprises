...
(function () {
  ...
  const dict = {
    ...
    'gallery.hero.title':      { en: 'Events & <span class="accent">Celebrations</span>', hi: 'इवेंट्स और <span class="accent">उत्सव</span>' },
    'gallery.hero.desc':       { en: 'Capturing special moments, team celebrations, staff gatherings, and operational milestones across Pawan Enterprise.', hi: 'पवन एंटरप्राइज में विशेष अवसरों, टीम उत्सवों, स्टाफ समारोहों और उपलब्धियों की झलकियां।' },
